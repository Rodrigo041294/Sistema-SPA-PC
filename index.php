                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-4 col-sm-6 col-md-offset-4 col-sm-offset-3">
                            <form method="POST" action="php/validations/signin.php">
                                <div class="card card-login card-hidden">
                                    <div class="card-header text-center" data-background-color="blue"><br><br><br>
                                    ...
                                    <div class="footer text-center">
                                        <button type="submit" class="btn btn-blue btn-simple btn-wd btn-lg">Iniciar Sesión</button>
                                    </div>
                                </div>
                            </form>
                        </div>
...
if(isset($_GET['error']))
{
  echo '<script type="text/javascript">demo.showSwal(\'error-login\');</script>';
}
?>
