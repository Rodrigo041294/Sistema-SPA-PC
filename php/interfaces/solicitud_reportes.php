                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="card card-calendar">
                            <div class="col-md-12">
                                <div class="material-datatables" id="lservicios22">
                                    <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="disabled-sorting">Fecha atencion deseada</th>
                                                <th class="disabled-sorting">Problema</th>
                                                <th class="disabled-sorting">Operaciones</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                           <?php require_once("../obtain/solicitudes_empresas.php");?>
                                       </tbody>
                                   </table>
                               </div>
                            </div>
...
<div class="modal fade" id="modalaceptar" role="dialog">
    <div class="modal-dialog modal-md">
      ...
      <div class="modal-body">
          <form class="form-horizontal" action="../request/aceptar_servicio.php" method="POST">
            <div class="modal-body">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group label-floating ">
                                        <input type="hidden" name="id_servicio_empresa" id="id_servicio_empresa">
