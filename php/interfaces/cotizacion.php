                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group label-floating ">
                                            <label class="control-label" >Cliente:</label>
                                             <select class="selectpicker" data-style="btn btn-primary btn-round" id="cliente">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                         <div class="form-group label-floating ">
                                            ...
                                            <input type="number" step=".01" class="form-control" id="cantidad"  name="cantidad">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                         <div class="form-group label-floating ">
                                ...
                                <div class="row">
                                    <div align="right">
                                        <button type="submit" id="agregar" name="cita" class="btn btn-success"><i class="material-icons">add</i></button>
                                        <button type="submit" id="enviar" name="cita" class="btn btn-primary"><i class="material-icons">send</i></button>
                                    </div>
                                </div>
                            </div>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <h4 class="card-title">Elementos Agregados</h4>
                                    <div class="toolbar">
                                        <!--        Here you can write extra buttons/actions for the toolbar              -->
                                    </div>
                                        ...
                                        <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="disabled-sorting">Concepto</th>
...
<script type="text/javascript">
    ...
    $("#agregar" ).click(function() {
        ...
        else
        {
            ...
            elementos[contador] = {precio, cantidad, concepto, total};
            console.log(elementos[contador]);
            agregar(contador, precio, cantidad, concepto, total);
            contador++;
        }
    ...
    $("#enviar" ).click(function() {
        ...
        $.ajax({
          type: "POST",
          url: "../request/cotizacion.php",
          data: {'array': JSON.stringify(elementos), 'cliente': id_cliente},//capturo array     
          success: function(data)
            {
                if(data != "errores")
                {
                    var url = "icotizacion.php?id="+data;
    ...
    function agregar(id, precio, cantidad, concepto, total)
    {
        var renglon = "<tr><td>"+cantidad+"</td><td>"+precio+"</td><td>"+concepto+"</td><td>"+total+"</td></tr>";
