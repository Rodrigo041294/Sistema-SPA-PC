                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <h4 class="card-title">Comercialización</h4>
                                    <div class="toolbar">
                                    
                                    </div>
                                    <div class="col-md-12">
                                <div class="row">
                                    <form action="../request/add_comercializacion.php" method="POST">
                                    <div class="col-md-12">
                                       <div class="form-group label-floating ">
                                            <label class="control-label" >Empresa:</label>
                                             <select class="selectpicker" data-style="btn btn-primary btn-round" name="empresa" id="empresaselect">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group label-floating is-focused">
                                           ...
                                           <input type="date" class="form-control" id="fsolicitud"  name="fsolicitud">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group label-floating is-focused">
                                            <label class="control-label" >Fecha Visita:</label>
                                           <input type="date" class="form-control" id="fvisita"  name="fvisita">
                                        </div>
                                    </div>
                                </div> 
                                <div class="row">
                                    <div class="col-md-2">
                                        <div class="form-group label-floating ">
                                            <label class="control-label" >Interesado:</label>
                                            <select class="form-control" name="interesado">
                                                <option>Si</option>
                                                <option>No</option>
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group label-floating ">
                                            <label class="control-label" >Trabajo Real (horas):</label>
                                           <input type="number" step=".01" class="form-control" id="tr"  name="tr">
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group label-floating ">
                                            <label class="control-label" >Duración Real (Horas):</label>
                                           <input type="number" step=".01" class="form-control" id="dr"  name="dr">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                                         <div class="form-group label-floating ">
                                            ...
                                            <textarea rows="5" class="form-control" name="notas"></textarea>
                                        </div>
                                    </div>
                                </div>    
                                <div class="row">
                                    <div align="right">
                                        <button type="submit" class="btn btn-success"><i class="material-icons">add</i> Registrar</button>
                                    </div>
                                </form>
                                </div>
                            </div>
...
<script type="text/javascript">
        $(function() {
        var availableTags = [
          <?php require("../obtain/empresas_auto.php"); ?>
        ];
