                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <h4 class="card-title">Lista de Recibos</h4>
                                    <div class="toolbar">
                                        ...
                                        <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="disabled-sorting">Fecha</th>
                                                    <th class="disabled-sorting">Suma</th>
                                                    <th class="disabled-sorting">Concepto</th>
                                                    <th class="disabled-sorting">Recibio</th>
                                                    <th class="disabled-sorting">Notas</th>
                                                    <th class="disabled-sorting text-right">Opciones</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                             <?php require_once("../obtain/recibos.php");?>
                                            </tbody>
                                        </table>
                                    </div>
                                </div>
