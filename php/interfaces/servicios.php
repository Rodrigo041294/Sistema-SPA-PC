...
$query_equipos = "SELECT s.id, e.nombre, s.fecha, s.hora, s.problema, s.solucion, s.observaciones, u.nombre, s.estatus FROM servicios s INNER JOIN usuarios u ON s.asignado = u.id INNER JOIN empresas e ON s.id_cliente = e.id";
